...
//[format["\x\addons\GMSCore_fnc_isBlacklisted called with position = %1 | _list = %2",_position, _list]] call GMSCore_fnc_log;
...
{
    //[format["\x\addons\GMSCore_fnc_isBlacklisted: evaluating for _pos %1 | _x %2",_position,_x]] call GMSCore_fnc_log;
