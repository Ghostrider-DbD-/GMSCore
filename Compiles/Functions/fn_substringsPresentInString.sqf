/*
	GMSCore_fnc_substringPresentInString
...
//[format["\x\addons\GMSCore_fnc_subsringsPresentInString: typename _string = %1 | _string = %2 | typename _substrings = %3 | _substrings = %4",typename _string, _string, typeName _substrings, _substrings]] call GMSCore_fnc_log;
if (_substrings isEqualTo []) exitWith {0};
private _count = 0;
{
	//[format["\x\addons\GMSCore_fnc_subsringsPresentInString: _x = %1",_x]] call GMSCore_fnc_log;
