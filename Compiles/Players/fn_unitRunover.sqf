...

{
	switch (_method) do 
	{
		...
		case 2: {  // strip unit of all gear
			...
			_unit call GMSCore_fnc_removeAllGear;
		};
		case 3: {  //  random hitpoint damage
				private _hpDamage = GMSCore_onRunoverHitpointDamage;
				private _noHpDamaged = [GMSCore_onRunoverNoHitPointsDamaged] call GMSCore_fnc_getIntegerFromRange;
