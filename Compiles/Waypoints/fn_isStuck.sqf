...
//[format["GMS_fnc_isStuck: _stuck %6 | _timeStamp %1 | _interval %2 | _timoutAt %3 | _timedOut %4 | _target %5",_timeStamp,_interval,_timeoutAt,_timedOut,_target,_stuck]] call GMS_fnc_log;
_stuck